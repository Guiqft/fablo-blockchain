...
function channelQuery() {
  ...
  then
    ...
    peerChannelGetInfo "my-channel1" "cli.org1.com" "peer0.org1.com:7041"

  elif [ "$1" = "fetch" ] && [ "$2" = "config" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org1" ] && [ "$5" = "peer0" ] && [ "$#" = 7 ]; then
    FILE_NAME=$6

    peerChannelFetchConfig "my-channel1" "cli.org1.com" "${FILE_NAME}" "peer0.org1.com:7041"

  elif [ "$1" = "fetch" ] && [ "$2" = "lastBlock" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org1" ] && [ "$5" = "peer0" ] && [ "$#" = 7 ]; then
    FILE_NAME=$6

    peerChannelFetchLastBlock "my-channel1" "cli.org1.com" "${FILE_NAME}" "peer0.org1.com:7041"

  elif [ "$1" = "fetch" ] && [ "$2" = "firstBlock" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org1" ] && [ "$5" = "peer0" ] && [ "$#" = 7 ]; then
    FILE_NAME=$6

    peerChannelFetchFirstBlock "my-channel1" "cli.org1.com" "${FILE_NAME}" "peer0.org1.com:7041"

  elif [ "$1" = "fetch" ] && [ "$2" = "block" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org1" ] && [ "$5" = "peer0" ] && [ "$#" = 8 ]; then
    FILE_NAME=$6
    BLOCK_NUMBER=$7

    peerChannelFetchBlock "my-channel1" "cli.org1.com" "${FILE_NAME}" "${BLOCK_NUMBER}" "peer0.org1.com:7041"

  elif
    [ "$1" = "getinfo" ] && [ "$2" = "my-channel1" ] && [ "$3" = "org1" ] && [ "$4" = "peer1" ]
  then

    peerChannelGetInfo "my-channel1" "cli.org1.com" "peer1.org1.com:7042"

  elif [ "$1" = "fetch" ] && [ "$2" = "config" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org1" ] && [ "$5" = "peer1" ] && [ "$#" = 7 ]; then
    FILE_NAME=$6

    peerChannelFetchConfig "my-channel1" "cli.org1.com" "${FILE_NAME}" "peer1.org1.com:7042"

  elif [ "$1" = "fetch" ] && [ "$2" = "lastBlock" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org1" ] && [ "$5" = "peer1" ] && [ "$#" = 7 ]; then
    FILE_NAME=$6

    peerChannelFetchLastBlock "my-channel1" "cli.org1.com" "${FILE_NAME}" "peer1.org1.com:7042"

  elif [ "$1" = "fetch" ] && [ "$2" = "firstBlock" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org1" ] && [ "$5" = "peer1" ] && [ "$#" = 7 ]; then
    FILE_NAME=$6

    peerChannelFetchFirstBlock "my-channel1" "cli.org1.com" "${FILE_NAME}" "peer1.org1.com:7042"

  elif [ "$1" = "fetch" ] && [ "$2" = "block" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org1" ] && [ "$5" = "peer1" ] && [ "$#" = 8 ]; then
    FILE_NAME=$6
    BLOCK_NUMBER=$7

    peerChannelFetchBlock "my-channel1" "cli.org1.com" "${FILE_NAME}" "${BLOCK_NUMBER}" "peer1.org1.com:7042"
